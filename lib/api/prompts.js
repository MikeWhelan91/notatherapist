...
The input contains today's entries only unless recent history is explicitly provided. Do not compare with "usual", "normally", "recently", or past behaviour unless the input includes that history.
